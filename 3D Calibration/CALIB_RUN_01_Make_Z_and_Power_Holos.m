...
CalibZ.N = 25;        %WAS 25                      %Number of points in the single axis z- calibration
...
PCalib.LY = 20;
PCalib.LZ = 20;
RX = 0.30; %This is the range, 0.5 is the MAX 
RY = 0.30;
PCalib.X = linspace(0.5-RX,0.5+RX,PCalib.LX );
PCalib.Y = linspace(0.5-RY,0.5+RY,PCalib.LY );
PCalib.Z =  linspace(-.05,.07,PCalib.LZ );   % 2018 02 27 changede from -0.07 to + 0.07
