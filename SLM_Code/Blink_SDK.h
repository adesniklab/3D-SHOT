...
public:
  ...
  // ----------------------------------------------------------------------------------------------
  /// @brief Set the triggering state for the SDK to "standard" mode for the Grizzly hardware. 
  ///        Must be called BEFORE construction of the SDK. 
  ///
  /// @param enable             @true or @false
  // ----------------------------------------------------------------------------------------------
  static void Preset_triggering_mode(bool enable);
